	...
	public void draw(TmtTessellator tessellator, float f)
	{
		...
		if(iNormals.size() == 0)
		{
			...
			if(vertexPositions.length >= 3)
			{
				...
				net.minecraft.util.Vec3 Vec31 = vertexPositions[1].vector3D.subtract(vertexPositions[2].vector3D);
				net.minecraft.util.Vec3 Vec32 = Vec31.crossProduct(Vec3).normalize();
